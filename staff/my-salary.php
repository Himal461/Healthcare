...
$stmt = $pdo->prepare("
    ...
    WHERE u.userId = ? AND u.role = 'staff'
");
$stmt->execute([$userId]);
$staffData = $stmt->fetch();

if (!$staffData) {
    $_SESSION['error'] = "Staff profile not found.";
...
$currentSalary = $staffData['salary'] ?? 2500.00;
...
<div class="staff-container">
    ...
    <!-- Current Salary Card -->
    <div class="staff-card" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white;">
        <div class="staff-card-body" style="display: flex; align-items: center; gap: 30px; padding: 35px;">
            ...
            <div>
                ...
                <p style="color: rgba(255,255,255,0.85); margin: 5px 0 0;">
                    <?php echo htmlspecialchars($staffData['position'] ?: 'Staff Member'); ?> · 
                    <?php echo htmlspecialchars($staffData['department'] ?: 'General'); ?>
                </p>
            </div>
        ...
        <div class="staff-card-body">
            <div class="staff-patient-info-grid">
                <div class="staff-info-group">
                    ...
                    <p><strong>Role:</strong> <span class="staff-role-badge"><?php echo ucfirst($staffData['role']); ?></span></p>
                    <p><strong>Position:</strong> <?php echo htmlspecialchars($staffData['position'] ?: 'N/A'); ?></p>
                            ...
                            <?php foreach ($salaryHistory as $payment): ?>
                                <tr>
                                    ...
                                    <td data-label="Actions">
                                        <a href="../view-salary-details.php?id=<?php echo $payment['salaryId']; ?>" class="staff-btn staff-btn-primary staff-btn-sm">
